...
public class runGUI extends Composite {
	...
	public runGUI(Composite parent, int style,KnowledgeBase kb,Shell sh) {
		...
		inference = new InferenceEngine(KBase,this);
		...
		//set this runGUI to a grid layout
		GridLayout gl_composite = new GridLayout(4, false);
		gl_composite.marginWidth = 3;
		this.setLayout(gl_composite);
		
		
		//make a group to hold kb selection/target var
		Group grpKnowledgeBaseSelected = UserFactoryGUI.createGroupKbSelect(this,SWT.NONE);
